...
class Dastan:
    ...
    def __GetIndexOfSquare(self, SquareReference):
        ...
        print(Row, Col)
        print((Row - 1) * self._NoOfColumns + (Col - 1))
...
def Main():
    rows = int(input("Enter how many rows should there be: "))
    cols = int(input("Enter how many columns should there be: "))
    pieces = int(input("Enter how many pieces should there be: "))
    ThisGame = Dastan(rows, cols, pieces)
    ThisGame.PlayGame()
    print("Goodbye!")
    input()

...
class pygame_window(object):
    def __init__(self, MAZE_HEIGHT, MAZE_WIDTH, maze):
        ...
        #instantiate sprites
        self.__player = Player("Player.png",[400,100])
    ...
    def display(self):
        ...
        keys = generate_maze(self.__maze_height, self.__maze_width, self.__maze, self.__walls, self.__cells, self.__all_sprites)
        ...
        while run:
            ...
            if pygame.sprite.spritecollideany(self.__player, self.__walls):
                self.__player.kill()
                player = Player("Player.png",[400,100])

...
def checkMovePath(array, moveFromX, moveFromY, moveToX, moveToY):
    pathClear = True
    print(moveFromX, moveToX)
    print(moveFromY, moveToY)
    for x in range(moveFromX, moveToX):
        for y in range(moveFromY, moveToY):
            print(array[x][y])
            if array[x][y] != None:
                pathClear = False
                print("The path is not clear - you cannot make this move!")
                break
    return pathClear

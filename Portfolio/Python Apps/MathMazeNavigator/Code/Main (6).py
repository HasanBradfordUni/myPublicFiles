...
class win_screen(object):
    def __init__(self):
        #initiate pygame
        pygame.init()

        #set the window up with title
        self.__win = pygame.display.set_mode((1900, 1000), pygame.RESIZABLE)
        ...
        self.__all_sprites.add(self.WinScreen)
...
class lose_screen(object):
    def __init__(self):
        ...
        #add sprites to all_sprites
        self.__all_sprites.add(self.LoseScreen)
...
class pygame_window(object):
    ...
    def display(self):
        ...
        while run:
            ...
            #checks if the lives has gone below 300
            if self.__lives < -300:

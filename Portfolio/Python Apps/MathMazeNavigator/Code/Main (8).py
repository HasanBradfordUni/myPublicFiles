...
class load_screen(screens):
    ...
    def loadGame(self, all_sprites, MAZE_HEIGHT, MAZE_WIDTH):
        ...
        return self._new_sprites, player, self.__scoreBoard, self.__livesCounter, self.__movesCounter, self.__timer
...
class pygame_window(screens):
    ...
    def display(self):
        ...
        loc5 = self.__locY1 - 14
        loc6 = self.__locY1 + 14
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    if loc3 <= mouse[0] <= loc4 and loc5 <= mouse[1] <= loc6:
                        ...
                        self._all_sprites, self.__player, self.__scoreBoard, self.__livesCounter, self.__movesCounter, self.__timer = LS.loadGame(self._all_sprites, self.__maze_height, self.__maze_width)
                        LS.display()

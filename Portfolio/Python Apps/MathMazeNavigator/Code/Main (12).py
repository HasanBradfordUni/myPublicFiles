...
class pygame_window(screens):
        ...
        while run:
            ...
            if self.moveUndone:
                ...
                if len(self.movesQueue) > 0:
                    self.undoMove()
                    player = Player("Player.png",self.lastMove)
    ...
    def undoMove(self):
        self.lastMove = self.movesQueue[len(self.movesQueue)-1] #get the last item from the queue
        self.movesQueue.remove(self.lastMove) #remove the last item from the queue
